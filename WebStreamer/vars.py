...
class Var(object):
    ...
    BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002067686063"))  # you NEED to use a CHANNEL when you're using MULTI_CLIENT
    ...
    UPDATES_CHANNEL = str(environ.get('UPDATES_CHANNEL', 'film4movieee'))
