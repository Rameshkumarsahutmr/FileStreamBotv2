...
class Var(object):
    ...
    BOT_TOKEN = str(environ.get("BOT_TOKEN", "6735482559:AAEcZwQr4XSnqd396K3X_LSXpg0aSVa-ZSY"))
    SLEEP_THRESHOLD = int(environ.get("SLEEP_THRESHOLD", "60"))  # 1 minute
    WORKERS = int(environ.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002047818278"))  # you NEED to use a CHANNEL when you're using MULTI_CLIENT
    PORT = int(environ.get("PORT", 8080))
    BIND_ADDRESS = str(environ.get("WEB_SERVER_BIND_ADDRESS", "https://filestreamz-a5d2043bedb1.herokuapp.com"))
    ...
    UPDATES_CHANNEL = str(environ.get('UPDATES_CHANNEL', 'rksmoviez'))
